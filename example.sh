...
#cat  /tmp/aisc-17306-33197722.txt | bin/bxtjson -s ../baxtore2/docs/schema/api.json -e contract -cc  | psql2 -d bxt_development -c  "copy contracts (document) from STDIN csv quote e'\x01' delimiter e'\x02'";
...
# time = 
 ...
 psql2 -d bxt_development -c "delete from contracts" \
     && time cat /tmp/aisc-17306-33197722.txt | bin/bxtjson -s ../baxtore2/docs/schema/api.json -e contract -cc  | psql2 -d bxt_development -c  "copy contracts (document) from STDIN csv quote e'\x01' delimiter e'\x02'";
